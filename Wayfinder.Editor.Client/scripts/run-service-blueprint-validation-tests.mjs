// Runs service-blueprint-validation.test.ts — pure checks, no fixtures needed. Uses Vite in SSR
...
try {
  const mod = await server.ssrLoadModule('/src/service-blueprint-editor/service-blueprint-validation.test.ts');
