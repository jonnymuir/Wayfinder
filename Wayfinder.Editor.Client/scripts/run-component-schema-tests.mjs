// Runs the pure component-schema/lint checks (component-schema-lint.test.ts) — no fixtures
// needed, unlike run-graph-layout-tests.mjs, since this exercises component-json-schema.ts and
