...
/// in-process alongside the host's own <c>MapPrismServiceBlueprintAuthoringApi()</c>, so tool calls
/// reach the same live <c>ServiceBlueprintAuthoringService</c> — no separate process, no stdio.
/// </summary>
public static class PrismServiceBlueprintAuthoringMcpExtensions
{
    /// <summary>
    /// Registers the MCP server and discovers <see cref="ServiceBlueprintAuthoringTools"/> and
    /// <see cref="ServiceBlueprintAuthoringResources"/> from this assembly.
    /// </summary>
    ...
    /// </param>
    public static IServiceCollection AddPrismServiceBlueprintAuthoringMcp(this IServiceCollection services, string? instructions = null)
    {
    ...
    /// </summary>
    public static IEndpointConventionBuilder MapPrismServiceBlueprintAuthoringMcp(
        this IEndpointRouteBuilder endpoints,
        string pattern = "/prism/service-blueprint-authoring/mcp") =>
