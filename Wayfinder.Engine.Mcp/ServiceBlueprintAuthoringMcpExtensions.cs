...
/// <summary>
/// Registers and maps the Wayfinder service blueprint authoring toolkit as MCP tools over HTTP. Hosted
/// in-process alongside the host's own <c>MapServiceBlueprintAuthoringApi()</c>, so tool calls
/// reach the same live <c>ServiceBlueprintAuthoringService</c> — no separate process, no stdio.
/// </summary>
public static class ServiceBlueprintAuthoringMcpExtensions
{
    /// <summary>
    ...
    /// </param>
    public static IServiceCollection AddServiceBlueprintAuthoringMcp(this IServiceCollection services, string? instructions = null)
    {
