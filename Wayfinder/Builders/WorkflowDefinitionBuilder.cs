...
/// <summary>
/// Fluent builder for creating v2.0 workflow definitions in code with full IntelliSense support.
...
public class WorkflowDefinitionBuilder
{
    ...
    /// <summary>Sets the unique key for this workflow definition.</summary>
    public WorkflowDefinitionBuilder Key(string definitionKey) { _definitionKey = definitionKey; return this; }

    /// <summary>Sets the human-readable display name for this workflow.</summary>
    public WorkflowDefinitionBuilder DisplayName(string name) { _displayName = name; return this; }

    /// <summary>Sets the version number for this workflow definition.</summary>
    public WorkflowDefinitionBuilder Version(int version) { _version = version; return this; }

    /// <summary>Sets the key of the state where users enter the workflow.</summary>
    public WorkflowDefinitionBuilder StartsAt(string stateKey) { _initialState = stateKey; return this; }

    /// <summary>Sets the instance creation policy: "single" | "multiple" | "prompt".</summary>
    public WorkflowDefinitionBuilder InstancePolicy(string policy) { _instancePolicy = policy; return this; }

    /// <summary>Adds a state to this workflow definition.</summary>
    public WorkflowDefinitionBuilder AddState(string stateKey, Action<StateBuilder> configure)
    {
        var builder = new StateBuilder(stateKey);
        configure(builder);
        _states.Add(builder.Build());
        return this;
    }

    /// <summary>Adds a transition (edge) between two states.</summary>
    ...
    /// <summary>Builds and returns a complete workflow definition file.</summary>
    public WorkflowDefinitionFile Build() => new()
    {
...
public abstract class ComponentCollectionBuilder<TSelf> where TSelf : ComponentCollectionBuilder<TSelf>
{
    ...
    /// <summary>Adds a waiting component for paused/long-running workflows.</summary>
...
/// <summary>Builder for a workflow state's <see cref="PrismComponent"/> tree.</summary>
public sealed class StateBuilder : ComponentCollectionBuilder<StateBuilder>
{
    private readonly string _stateKey;
    private string _displayName = "";

    internal StateBuilder(string stateKey) { _stateKey = stateKey; }

    protected override StateBuilder Self => this;

    /// <summary>Sets the human-readable display name for this state.</summary>
...
/// <summary>
/// Plain bag of <see cref="PrismComponent"/>s for contexts that aren't a fieldset or state
...
public sealed class SummaryListBuilder
{
    ...
    public SummaryListBuilder ChangeStateKey(string stateKey) { _changeStateKey = stateKey; return this; }
